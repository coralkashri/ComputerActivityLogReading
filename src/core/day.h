...
struct day {
    ...
    inline bool operator==(const day& ref) { return day_name == ref.day_name && short_day_name == ref.short_day_name && day_symbol == ref.day_symbol; }
    inline bool operator==(const std::string& ref) { return day_name == ref || short_day_name == ref; }
